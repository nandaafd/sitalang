...
class MasterPelanggaranController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('web.masterpelanggaran.index', compact('pelanggaran','nama','kat','kategori'));
    }
    public function create()
    {
        ...
        return view('web.masterpelanggaran.create', compact('kategori'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('pelanggaran.index')->with('err','gagal menambah data, internal server error');
        }
        return redirect()->route('pelanggaran.index')->with('success','berhasil menambah data master pelanggaran');
    }
    ...
    public function edit($id)
    {
        ...
        return view('web.masterpelanggaran.edit', compact('kategori','pelanggaran'));
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('pelanggaran.index')->with('err','gagal edit data, internal server error');
        }
        return redirect()->route('pelanggaran.index')->with('success','berhasil mengedit data master pelanggaran');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect('/pelanggaran')->with('err',$ex->getMessage());
        }
        return redirect()->route('pelanggaran.index')->with('success','berhasil menghapus data master pelanggaran');
    }
}
